...
function build_tailwind() {
  var scssFiles = "src/assets/scss/*.scss";
  var cssDestsrc = "src/assets/css";
  var cssDestdist = "dist/assets/css";
  return src(scssFiles)
    .pipe(sass$.sync().on("error", sass$.logError))
    .pipe(postcss([tailwindcss, autoprefixer]))
    .pipe(dest(cssDestsrc))
    .pipe(dest(cssDestdist));
}
// functions
...
function copyfile() {
  ...
  return src("src/assets/iconfonts/**/*")
    .pipe(dest("dist/assets/iconfonts"));
}
...
function watchTask() {
    ...
    watch(["src/assets/scss/**/*.scss"], build_tailwind);
    watch(["src/assets/scss/**/*.scss"], scss);
    watch(['src/assets/img/*.{jpg,png}','src/assets/img/*/*.{jpg,png}','src/assets/img/**/**/*.{jpg,png}'], webpImage);
